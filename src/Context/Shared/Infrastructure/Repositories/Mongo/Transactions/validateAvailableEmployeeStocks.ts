...
import { StateOrder, EmployeeStockENTITY, StateInventory, StateInternalOrderWin, WINOrderENTITY, OrderStockENTITY } from 'logiflowerp-sdk'
...
export async function _validateAvailableEmployeeStocks(params: Props) {
    const { colWarehouseReturn, colEmployeeStock, colWinOrderStock, colWinOrder, pipeline, _ids } = params
